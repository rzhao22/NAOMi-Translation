...
def  separateByCorrelation(cnmf,suite2p,pcaica,est,cuttoff):
    ...
    cnmf.allpairs.strongcomp = np.mean(bsxfun(@rdivide,cnmf.allpairs.strongcomp,max(max(cnmf.allpairs.strongcomp,[],1),[],2)),3)
    cnmf.allpairs.strongcomp = cnmf.allpairs.strongcomp./np.mean(cnmf.allpairs.strongcomp(cnmf.allpairs.strongcomp!=0))
    ...
    cnmf.allpairs.weakcomp = np.mean(bsxfun(@rdivide,cnmf.allpairs.weakcomp,max(max(cnmf.allpairs.weakcomp,[],1),[],2)),3)
    cnmf.allpairs.weakcomp = cnmf.allpairs.weakcomp./np.mean(cnmf.allpairs.weakcomp(cnmf.allpairs.weakcomp!=0))
    ...
    cnmf.allpairs.upcomp = np.mean(bsxfun(@rdivide,cnmf.allpairs.upcomp,max(max(cnmf.allpairs.upcomp,[],1),[],2)),3)
    cnmf.allpairs.upcomp = cnmf.allpairs.upcomp./np.mean(cnmf.allpairs.upcomp(cnmf.allpairs.upcomp!=0))
    ...
    pcaica.allpairs.strongcomp = np.mean(bsxfun(@rdivide,pcaica.allpairs.strongcomp,max(max(pcaica.allpairs.strongcomp,[],1),[],2)),3)
    pcaica.allpairs.strongcomp = pcaica.allpairs.strongcomp./np.mean(pcaica.allpairs.strongcomp(pcaica.allpairs.strongcomp!=0))
    ...
    pcaica.allpairs.weakcomp = np.mean(bsxfun(@rdivide,pcaica.allpairs.weakcomp,max(max(pcaica.allpairs.weakcomp,[],1),[],2)),3)
    pcaica.allpairs.weakcomp = pcaica.allpairs.weakcomp./np.mean(pcaica.allpairs.weakcomp(pcaica.allpairs.weakcomp!=0))
    ...
    pcaica.allpairs.upcomp = np.mean(bsxfun(@rdivide,pcaica.allpairs.upcomp,max(max(pcaica.allpairs.upcomp,[],1),[],2)),3)
    pcaica.allpairs.upcomp = pcaica.allpairs.upcomp./np.mean(pcaica.allpairs.upcomp(pcaica.allpairs.upcomp!=0))
    ...
    suite2p.allpairs.strongcomp = np.mean(bsxfun(@rdivide,suite2p.allpairs.strongcomp,max(max(suite2p.allpairs.strongcomp,[],1),[],2)),3)
    suite2p.allpairs.strongcomp = suite2p.allpairs.strongcomp./np.mean(suite2p.allpairs.strongcomp(suite2p.allpairs.strongcomp!=0))
    ...
    suite2p.allpairs.weakcomp = np.mean(bsxfun(@rdivide,suite2p.allpairs.weakcomp,max(max(suite2p.allpairs.weakcomp,[],1),[],2)),3)
    suite2p.allpairs.weakcomp = suite2p.allpairs.weakcomp./np.mean(suite2p.allpairs.weakcomp(suite2p.allpairs.weakcomp!=0))
    ...
    suite2p.allpairs.upcomp = np.mean(bsxfun(@rdivide,suite2p.allpairs.upcomp,max(max(suite2p.allpairs.upcomp,[],1),[],2)),3)
    suite2p.allpairs.upcomp = suite2p.allpairs.upcomp./np.mean(suite2p.allpairs.upcomp(suite2p.allpairs.upcomp!=0))
    ...
    est.allpairs.strongcomp = np.mean(bsxfun(@rdivide,est.allpairs.strongcomp,eps+max(max(est.allpairs.strongcomp,[],1),[],2)),3)
    est.allpairs.strongcomp = est.allpairs.strongcomp./(eps+np.mean(est.allpairs.strongcomp(est.allpairs.strongcomp!=0)))
    ...
    est.allpairs.weakcomp   = np.mean(bsxfun(@rdivide,est.allpairs.weakcomp,eps+max(max(est.allpairs.weakcomp,[],1),[],2)),3)
    est.allpairs.weakcomp   = est.allpairs.weakcomp./(eps+np.mean(est.allpairs.weakcomp(est.allpairs.weakcomp!=0)))
    ...
    est.allpairs.upcomp     = np.mean(bsxfun(@rdivide,est.allpairs.upcomp,eps+max(max(est.allpairs.upcomp,[],1),[],2)),3)
    est.allpairs.upcomp     = est.allpairs.upcomp./(eps+np.mean(est.allpairs.upcomp(est.allpairs.upcomp!=0)))

    return [cnmf,suite2p,pcaica,est]
