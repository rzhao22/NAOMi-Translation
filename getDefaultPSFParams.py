...
# psf_params = getDefaultPSFParams(psf_type)
#
# Function to get default parameters for a number of standard optical 
# setups. Includes 'gaussian', 'bessel','temporal-focusing', 
# 'three-photon' and 'misaligned'.
#
# 2019 - Alex Song and Adam Charles

##########################################################################

def getDefaultPSFParams(psf_type):
    match psf_type:
        case 'gaussian':
            psf_params.NA       = 0.5
        case 'vtwins':
            ...
            psf_params.n        = TMP.n
            psf_params.lambdaWave   = TMP.lambdaWave
            psf_params.beamNA = psf_params.n*sqrt(1-(0.626*psf_params.lambdaWave/(psf_params.length*psf_params.n)-1)^2)
        ...
        case 'bessel':
            ...
            psf_params.NA        = 0.4                                            # sets Bessel beam diameter (1.629*lambdaWave*n/(2*pi*NA))
        ...
        case 'misaligned':
            psf_params.zernikeWt  = 3*[0 0 0 0 0.2 0 0 0 0 0 0.25]                     # Default microscope aberration weights (Zernike basis). In units of wavelength, a small amount of spherical aberration and astigmatism added as uncorrected "system" aberrations
